    ...
    def _create_default_patterns(self):
        ...
        default_patterns = {
            "expansion": [
                ...
                {"pattern": r"what is (.+)", "replacement": r"define and explain in detail \1"},
                {"pattern": r"why (.+)", "replacement": r"explain the reasons why \1"}
            ],
            "precision": [
                {"pattern": r"information about (.+)", "replacement": r"specific and detailed information about \1"},
                {"pattern": r"talk about (.+)", "replacement": r"explain in detail \1 with concrete examples"},
                {"pattern": r"I want to know (.+)", "replacement": r"provide detailed information about \1"}
            ],
            "context": [
                {"pattern": r"(.+) project (.+)", "replacement": r"\1 project \2 in the context of our company"},
                {"pattern": r"(.+) process (.+)", "replacement": r"\1 process \2 according to our internal documentation"}
            ]
        }
