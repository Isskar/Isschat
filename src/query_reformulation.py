    ...
    def _create_default_patterns(self):
        ...
        default_patterns = {
            "expansion": [
                ...
                {"pattern": r"comment (.+)", "replacement": r"explique en détail comment \1"},
                {"pattern": r"qu'est-ce que (.+)", "replacement": r"définis et explique en détail \1"},
                {"pattern": r"pourquoi (.+)", "replacement": r"explique les raisons pour lesquelles \1"}
            ],
            "precision": [
                {"pattern": r"information sur (.+)", "replacement": r"informations spécifiques et détaillées sur \1"},
                {"pattern": r"parle de (.+)", "replacement": r"explique en détail \1 avec des exemples concrets"},
                {"pattern": r"je veux savoir (.+)", "replacement": r"fournir des informations détaillées sur \1"}
            ],
            "context": [
                {"pattern": r"(.+) projet (.+)", "replacement": r"\1 projet \2 dans le contexte de notre entreprise"},
                {"pattern": r"(.+) processus (.+)", "replacement": r"\1 processus \2 selon notre documentation interne"}
            ]
        }
