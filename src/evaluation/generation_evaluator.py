...
from .models import TestCase, EvaluationResult, GenerationScore, RobustnessScore, RobustnessTestType, PerformanceMetrics
import sys
import os
...
class GenerationEvaluator:
    ...
    def evaluate_response(
        ...
        try:
            ...
            generation_score = self.llm_judge.evaluate_generation(
                question=question, context=context, response=response, expected_answer=expected_answer
            )
    ...
    def evaluate_robustness_test(self, test_case: TestCase, response: str, sources: List[str]) -> EvaluationResult:
        """
    ...
    def evaluate_batch(self, test_cases: List[TestCase], get_response_func: callable) -> List[EvaluationResult]:
        """
    ...
    def get_statistics(self) -> Dict[str, Any]:
        ...
        """
        avg_time = self.total_evaluation_time / self.evaluations_completed if self.evaluations_completed > 0 else 0.0
