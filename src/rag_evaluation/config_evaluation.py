...
from config import LLMConfig, LLMPrompt
...
def get_config() -> EvaluationConfig:
    ...
    config.llm.api_base = os.getenv("LLM_API_BASE", "https://openrouter.ai/api/v1")
    ...
    # Initialize pydantic-ai agents with model information
    # Note: we access the model_name from config.llm before initializing the agents
    model_settings = {"api_key": config.llm.api_key, "api_base": config.llm.api_base}
