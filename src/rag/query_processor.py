...
class QueryProcessor:
    ...
    def _extract_keywords(self, query: str) -> List[str]:
        ...
        stop_words = {
            'le', 'la', 'les', 'un', 'une', 'des', 'du', 'de', 'da', 'et', 'ou', 'est', 'sont', 'avec',
            'sur', 'dans', 'pour', 'par', 'qui', 'que', 'quoi', 'comment', 'où', 'quand', 'pourquoi',
            'the', 'a', 'an', 'and', 'or', 'is', 'are', 'with', 'on', 'in', 'for', 'by', 'who', 'what',
            'where', 'when', 'why', 'how', 'this', 'that', 'these', 'those', 'can', 'could', 'should',
            'nous', 'vous', 'ils', 'elles', 'je', 'tu', 'il', 'elle', 'me', 'te', 'se', 'nous', 'vous',
            'moi', 'toi', 'lui', 'elle', 'eux', 'elles', 'mon', 'ton', 'son', 'ma', 'ta', 'sa', 'mes',
