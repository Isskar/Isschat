...
class SemanticRetrievalTool:
    ...
    def retrieve(
        ...
        try:
            ...
            if use_semantic_expansion:
                ...
                self.logger.debug(f"Query processed: intent={query_result.intent}, "
    ...
    def _semantic_rerank(
        ...
        try:
            ...
            for candidate in candidates:
                ...
                semantic_score = self._embedding_service.similarity(
                    original_query_embedding, content_embedding
                )
    ...
    def _calculate_intent_bonus(self, intent: str, candidate: RetrievalDocument) -> float:
        ...
        intent_keywords = {
            "team_info": ["équipe", "team", "collaborateurs", "membres", "vincent", "nicolas", "emin", 
                         "fraillon", "lambropoulos", "calyaka", "composition", "responsabilités"],
    ...
    def test_semantic_retrieval(self, test_query: str = "qui sont les collaborateurs sur Isschat") -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                ...
                "improvement": {
                    "score_improvement": (semantic_results[0].score - basic_results[0].score) if semantic_results and basic_results else 0,
                    "semantic_features_help": len(semantic_results) > 0 and (not basic_results or semantic_results[0].score > basic_results[0].score)
                }
            }
