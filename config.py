...
# Charge les variables d'environnement depuis un fichier .env #LANGUAGE
load_dotenv()

# Variables Confluence
CONFLUENCE_PRIVATE_API_KEY = os.getenv("CONFLUENCE_PRIVATE_API_KEY")
CONFLUENCE_API_KEY = os.getenv("CONFLUENCE_PRIVATE_API_KEY")  # Alias pour compatibilité #LANGUAGE
CONFLUENCE_SPACE_KEY = os.getenv("CONFLUENCE_SPACE_KEY")
CONFLUENCE_SPACE_NAME = os.getenv("CONFLUENCE_SPACE_NAME")
CONFLUENCE_USERNAME = os.getenv("CONFLUENCE_EMAIL_ADRESS")  # Utilise l'email comme username  #LANGUAGE
CONFLUENCE_EMAIL_ADRESS = os.getenv("CONFLUENCE_EMAIL_ADRESS")

# Chemins de fichiers et dossiers #LANGUAGE
# Utiliser des chemins absolus pour éviter les problèmes de résolution de chemin   #LANGUAGE
