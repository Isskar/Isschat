...
from src.evaluation import EvaluationManager, TestType
...
def test_llm_judge():
    ...
    try:
        ...
        print(f"✅ Generation evaluation completed")
...
def test_quick_evaluation():
    ...
    try:
        ...
        results = manager.run_quick_evaluation(
            ...
            get_response_func=mock_get_response,
            session_name="Test Quick Evaluation"
        )
...
def test_robustness_evaluation():
    ...
    try:
        ...
        results = manager.run_robustness_tests(
            get_response_func=mock_get_response,
            session_name="Test Robustness Evaluation"
        )
